  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/sfeagle-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/sfeagle-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build sfeagle-style-guide.gemspec && mv sfeagle-style-guide-' + userConfig.client.version + '.gem ../sfeagle-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install sfeagle-style-guide-' + userConfig.client.version + '.gem && rm sfeagle-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
